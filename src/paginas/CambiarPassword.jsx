...
const CambiarPassword = () => {
  ...
  return (
    <>
        <AdminNav />
        <h2 className="font-black font-bold text-3xl text-center mt-10" >Cambiar Password</h2>
            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                ...
                <form action="" onSubmit={handleSubmit}>
                  ...
                  <input 
                      ...
                      className="bg-indigo-700 text-white font-bold w-full text-center px-10 py-3 uppercase mt-5 rounded-lg"
                  />
