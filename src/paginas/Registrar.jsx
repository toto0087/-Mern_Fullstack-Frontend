        ...
        <>
            ...
            
            {
              ...
              >
                ...
                <div className="my-5">
                  <label htmlFor="" className="uppercase text-gray-600 font-bold text-xl block" >Nombre</label>
                  <input 
                    type="text" 
                ...
                <div className="my-5">
                  <label htmlFor="" className="uppercase text-gray-600 font-bold text-xl block" >Repetir Password</label>
                  <input 
                    type="password" 
              ...
              <nav className=" lg:flex mt-10 lg:flex-col lg:items-start ">
                  <Link 
                    ...
                    to="/">¿Ya tienes una cuenta? Inicia Secion</Link>
                  <Link 
                    className=" block text-center my-5 text-gray-500 "
